...
#define OBJECT_TYPE_RED_KOOPA 6
...
#define ID_SPRITE_RED_KOOPA 60000
#define ID_SPRITE_RED_KOOPA_WALK (ID_SPRITE_RED_KOOPA+1000)
#define ID_SPRITE_RED_KOOPA_WALK_LEFT (ID_SPRITE_RED_KOOPA_WALK+100)
#define ID_SPRITE_RED_KOOPA_WALK_RIGHT (ID_SPRITE_RED_KOOPA_WALK+200)
#define ID_SPRITE_RED_KOOPA_ROLL (ID_SPRITE_RED_KOOPA+2000)